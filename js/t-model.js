...
function TShapeCalculator() {
    const translations = {
        en: {
            ...
            flangeMaterial: 'Flange material mechanical properties',
            ...
            flangewidth:'Flange width bf (mm)',
            edgedistance:'Bolt edge distance n (mm)',
            effectiveDiameter: 'Bolt effective diameter (mm)',
            flangeThickness: 'Flange thickness tf (mm)',
            widthLf: 'Flange width lf (mm)',
            calculatedLength: 'Bolt calculated length LB (mm)',
            boltHeadDiameter: 'Bolt head diameter (mm)',
            washerDiameter: 'Washer diameter (mm)',
            boltMaterial: 'Bolt material mechanical properties',
        ...
        zh: {
            ...
            flangewidth:'翼缘宽度 bf (mm)',
            edgedistance:'螺栓边距 n (mm)',
            effectiveDiameter: '螺栓有效直径 (mm)',
            flangeThickness: '翼缘厚度 tf (mm)',
            widthLf: '翼缘宽度 lf (mm)',
            calculatedLength: '螺栓计算长度 LB (mm)',
            boltHeadDiameter: '螺栓头直径 (mm)',
            washerDiameter: '垫圈直径 (mm)',
            boltMaterial: '螺栓材料力学性能',
            yieldStrain: '屈服应变',
            ultimateStrain: '极限应变',
            fractureStrain: '断裂应变',
